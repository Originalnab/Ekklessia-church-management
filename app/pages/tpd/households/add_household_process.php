...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$name || !$assembly_id || !$address || !$digital_address || !$created_by || !$updated_by) {
    ...
    try {
        ...
        $stmt = $pdo->prepare("INSERT INTO households (name, assembly_id, address, digital_address, status, nearest_landmark, date_started, created_by, updated_by, created_at, updated_at) 
                               VALUES (:name, :assembly_id, :address, :digital_address, :status, :nearest_landmark, :date_started, :created_by, :updated_by, NOW(), NOW())");
