...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function renderEventsTable(tab, events) {
        ...
        if (events.length > 0) {
            ...
            // Let's test our date formatting directly
            document.getElementById('debug-output') && document.getElementById('debug-output').remove();
            const debugDiv = document.createElement('div');
            debugDiv.id = 'debug-output';
            debugDiv.style.display = 'none';
            debugDiv.innerHTML = `
                <h4>Debug Date Format Test</h4>
                <p>Original date: ${events[0].start_date}</p>
                <p>Formatted date: ${formatDateWords(events[0].start_date)}</p>
            `;
            document.body.appendChild(debugDiv);
            console.log('Debug div added with sample date format.');
        }
        ...
        events.forEach((ev, i) => {
            ...
            console.log(`Event ${i + 1} dates - start: ${startDate}, end: ${endDate}`);
            ...
            try {
                ...
                console.log(`Event ${i + 1} formatted - start: ${startDateFormatted}, end: ${endDateFormatted}`);
            } catch (e) {
    ...
    // Attach event handlers for edit and delete buttons    function attachEventButtonHandlers() {
    document.querySelectorAll('.edit-event').forEach(btn => {
        btn.addEventListener('click', function () {
            ...
            // Call the edit modal loader from event-edit-handlers.js
